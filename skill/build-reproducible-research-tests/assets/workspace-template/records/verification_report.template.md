# Verification Report: {{TEST_TITLE}}
...
|---|---|---|---|---|---|
| Structural | {{CHECK}} | {{EXPECTED}} | {{ACTUAL}} | {{PASS|FAIL|WARN}} | {{EVIDENCE}} |
...
- Scientific acceptance: {{PASS|FAIL|NOT_DEFINED}}
- Acceptance criterion: {{CRITERION_OR_NOT_DEFINED}}
- Supporting result: {{RELATIVE_RESULT_OR_EVIDENCE_ID}}
